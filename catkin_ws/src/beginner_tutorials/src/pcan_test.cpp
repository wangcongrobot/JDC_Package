...
void Fifo_array_datasend(beginner_tutorials::ForceData force_msg,int server_fifo_fd,int sensor_id,sensor_flag *sensorflag);
...
int main(int argc, char *argv[])
{
    ...
    if(fifo_send_on) close(server_fifo_fd);
    return 0;
}
