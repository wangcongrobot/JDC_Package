...
bool kinect_scan_not_found_flag;   //data[0]=17
bool kinect_scan_out_range_flag;   //data[0]=16
...
void notice_pub_sub::notice_msgCallback(const id_data_msgs::ID_Data::ConstPtr &notice_msg)
{
    ...
    {
        kinect_scan_not_found_flag = true;
        kinect_scan_finished_flag=true;
    }

    if(notice_message.id==3 && notice_message.data[0]==16)
    {
        kinect_scan_out_range_flag = true;
        kinect_scan_finished_flag=true;
    }
...
*/
            ...
            kinect_scan_not_found_flag = false;
            kinect_scan_out_range_flag = false;
            notice_data_clear(&notice_data);
            notice_data.id=3;
            notice_data.data[0]=1;
            notice_data.data[1]=column[loop_sys_cnt];
            ...
            if(kinect_scan_not_found_flag || kinect_scan_out_range_flag)
                continue;
